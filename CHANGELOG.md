...
### [5.0.1](https://github.com/xpyjs/gantt/compare/v5.0.0...v5.0.1) (2023-06-05)
...
* **components:** 不再支持 ganttColumnWidth 属性
* **init:** all
...
* **components:** add a toast ([f618194](https://github.com/xpyjs/gantt/commit/f61819473963f897f1a1f4930a43c8c2e3faa62b))
* **components:** add a toast when trigger no-date-error event ([efa707e](https://github.com/xpyjs/gantt/commit/efa707ed1ca8bd429758b092d77be809ce1dc776))
* **components:** add column label prop depth read attr ([c9b25f1](https://github.com/xpyjs/gantt/commit/c9b25f135b52b1a16c96aecce9e72fdef23c8aa4))
* **components:** add deep checked by right click ([261c54d](https://github.com/xpyjs/gantt/commit/261c54d4e9548a6e2b32e3f849bf5412fe049c1c)), closes [#16](https://github.com/xpyjs/gantt/issues/16)
* **components:** add progress-bar in slider ([be0d24b](https://github.com/xpyjs/gantt/commit/be0d24b74a960437a567d0013cf741ba1c8f4c92))
* **components:** add two props in column component(class & style) ([edd2bbf](https://github.com/xpyjs/gantt/commit/edd2bbf74eaffd55230c93debfafaef43fa3667e)), closes [#7](https://github.com/xpyjs/gantt/issues/7)
* **components:** 增添表头的显示选项，可以选择按日、周、月显示进度 ([20ef19a](https://github.com/xpyjs/gantt/commit/20ef19a6a71ed777bbb08fffcc54a02f0256f2e3)), closes [#3](https://github.com/xpyjs/gantt/issues/3)
* **components:** 添加按需引入 ([18059cc](https://github.com/xpyjs/gantt/commit/18059ccdd69e6219ee7fa71b159308e77802733f))
* **init:** 初始提交，vue3版本 ([4d8f02f](https://github.com/xpyjs/gantt/commit/4d8f02fa394e31c87605bf6fc3ad5cfcfba30296))
* **other:** update typings ([05d3acf](https://github.com/xpyjs/gantt/commit/05d3acfbd0e717996c266fae934c8b64ba84a095))
* **styles:** add success bar when move slider succeed ([e8c2916](https://github.com/xpyjs/gantt/commit/e8c2916ef434d2f3b753ca2c6590364a42adc434))
* **styles:** 新增设置按钮的显示控制，同时外置了设置内容方法 ([02d4eac](https://github.com/xpyjs/gantt/commit/02d4eace28a9f3907cbe3e0083d14ae51a407491))


### Bug Fixes

* **components:** fix incomplete data thrown by move-slider emit in linkage ([4bec2d1](https://github.com/xpyjs/gantt/commit/4bec2d1eab429881b601b77383c6d5592b5094c7))
* **components:** fix JGanttColumn repeated loading ([8f520bf](https://github.com/xpyjs/gantt/commit/8f520bfb3940504e6b7c387402ffb1f73248eda3)), closes [#5](https://github.com/xpyjs/gantt/issues/5)
* **components:** fix multi gantt component in one page problem ([8f1f9db](https://github.com/xpyjs/gantt/commit/8f1f9dba7087d8e16ac64cc1c8df89e3997fb6ce)), closes [#10](https://github.com/xpyjs/gantt/issues/10)
* **components:** fix start-key and end-key invalid ([a501b32](https://github.com/xpyjs/gantt/commit/a501b329f5dc21fa30249183d473e48f375fdcf6)), closes [#11](https://github.com/xpyjs/gantt/issues/11)
* **components:** fix successbar position problem ([0655cdf](https://github.com/xpyjs/gantt/commit/0655cdf19b0ef66dca82be046689c948a07ec926)), closes [#15](https://github.com/xpyjs/gantt/issues/15)
* **components:** optimize header highlight ([e83d3c9](https://github.com/xpyjs/gantt/commit/e83d3c97c49a0387804b8521490e17218c09a3ec))
* **components:** update progress slider not move rule ([5152a8d](https://github.com/xpyjs/gantt/commit/5152a8d5cc686f443fce1444f57d454d23d58596))
* **components:** update row-height linkage ([7f630ec](https://github.com/xpyjs/gantt/commit/7f630ec3ad404b015dead55131dd750429674736)), closes [#13](https://github.com/xpyjs/gantt/issues/13)
* **components:** update silder progress decimal ([2b34436](https://github.com/xpyjs/gantt/commit/2b344361fdf542bca7b13d8404c0c70bebfa1070))
* **components:** 修改成功条显示时长 ([b26afd4](https://github.com/xpyjs/gantt/commit/b26afd41769d68fa7679c6ca25da0867cb0f32db))
* **composables:** fix jump function error ([88c9f71](https://github.com/xpyjs/gantt/commit/88c9f719ed00d0648b42e6c54bbccac584bae5a2))
* **composables:** update event propagation rule ([2f60af7](https://github.com/xpyjs/gantt/commit/2f60af7aa0c190b3f2db291b0fdab5e66b2b6791))
* **dependencies:** fix import css bug ([56f1bda](https://github.com/xpyjs/gantt/commit/56f1bda8edfe64fbfa89faa0e35f9de3dd693b97)), closes [#8](https://github.com/xpyjs/gantt/issues/8)
* fix build error ([c3392b1](https://github.com/xpyjs/gantt/commit/c3392b12fadd8e32e0948c6f55d135257e5ef875))
* fix build error ([e921d1d](https://github.com/xpyjs/gantt/commit/e921d1d817d4f168de603157b88e4f796ece1caa))
* fix build error ([3d40bd1](https://github.com/xpyjs/gantt/commit/3d40bd119293ed4951b0bd4d2264db854cb6f836))
* fix build error ([2aa0327](https://github.com/xpyjs/gantt/commit/2aa03278450ae5bd9ddcf894a0924174d6040288))
* **merge:** 修复在不同显示条件下，拖动滑块的日期生成错误 ([b7b4f3a](https://github.com/xpyjs/gantt/commit/b7b4f3ac194e69bd42b57246bb98051461ac13c9))
* **other:** fix main ([c09427c](https://github.com/xpyjs/gantt/commit/c09427c5775d8714e9bc5486bfc46c819c0013e0))
* **style:** fix gantt width too long when changed unit or column size ([0542ea4](https://github.com/xpyjs/gantt/commit/0542ea4ef6bb6f41f5cce4489a40ae66380e5bcf))
* **style:** fix today line left diff ([25b038f](https://github.com/xpyjs/gantt/commit/25b038f8068443067ab368c77c904221368cf26a))
* **styles:** added highlight header when hover slider ([0f50c24](https://github.com/xpyjs/gantt/commit/0f50c248df8f3f815335a189d23a6ddc3702e248))
* **styles:** adjust setting btn position ([9f123a7](https://github.com/xpyjs/gantt/commit/9f123a705d9e65ece6ed3a83aeff3e20a99474d5))
* **styles:** fix column chunk style ([dd14eac](https://github.com/xpyjs/gantt/commit/dd14eacb4fb4c6957e3a98f9e3509fc368893dc5)), closes [#6](https://github.com/xpyjs/gantt/issues/6)
* **styles:** fix icon class prefix ([cafae5b](https://github.com/xpyjs/gantt/commit/cafae5b3a4c7397b4e63c343a3d351bd988ff07d)), closes [#12](https://github.com/xpyjs/gantt/issues/12)
* **styles:** fix repeated row bottom border ([bfe7e21](https://github.com/xpyjs/gantt/commit/bfe7e219786cf296cdcf4028843455a4d9ad6915))
* **styles:** fix weekend and today line are above slider ([1d6bb05](https://github.com/xpyjs/gantt/commit/1d6bb05072e22bcf40b4ca1751bd24a024423d22))
* **styles:** fix weekend line height ([21e75df](https://github.com/xpyjs/gantt/commit/21e75df0320ba519efb2ecb1251f1444570b6353))
* **style:** 修正颜色变更的响应问题 ([03c2280](https://github.com/xpyjs/gantt/commit/03c2280879b35104c5e4db2a355458988e3b3326))
